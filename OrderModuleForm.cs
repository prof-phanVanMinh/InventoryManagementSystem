...
namespace InventoryManagementSystem
{
    public partial class OrderModuleForm : Form
    {
        ...
        public void LoadProduct()
        {
            ...
            cm = new SqlCommand("SELECT pid, pname, pqty, pprice, pdescription, catname FROM [tbProduct] p INNER JOIN [tbCategory] c ON c.catid = p.catid WHERE CONCAT(pid, pname, pprice, pdescription, catname) LIKE '%" + txtSearchProd.Text + "%'", con);
            con.Open();
            dr = cm.ExecuteReader();
            while (dr.Read())
            {
